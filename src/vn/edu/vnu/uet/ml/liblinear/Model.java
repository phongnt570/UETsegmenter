...
import static vn.edu.vnu.uet.ml.liblinear.Linear.copyOf;
...
public final class Model implements Serializable {
	 ...
	 * label_idx. For classification models, if label_idx is not in a valid
	 * range (0 to nr_class-1), then a zero value will be returned; for
	 * regression models, label_idx is ignored.
	 *
	 * @since 1.95
	 */
